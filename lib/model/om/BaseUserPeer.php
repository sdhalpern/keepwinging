...
abstract class BaseUserPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Picture', 'RfidTag', 'TeamId', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'picture', 'rfidTag', 'teamId', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::PICTURE, self::RFID_TAG, self::TEAM_ID, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'picture', 'rfid_tag', 'team_id', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Picture' => 2, 'RfidTag' => 3, 'TeamId' => 4, 'CreatedAt' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'picture' => 2, 'rfidTag' => 3, 'teamId' => 4, 'createdAt' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::PICTURE => 2, self::RFID_TAG => 3, self::TEAM_ID => 4, self::CREATED_AT => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'picture' => 2, 'rfid_tag' => 3, 'team_id' => 4, 'created_at' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function clearRelatedInstancePool()
	{
		...
		// invalidate objects in FeedPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(FeedPeer::USER_ID, $obj->getId());
