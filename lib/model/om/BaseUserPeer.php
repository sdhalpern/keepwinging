...
abstract class BaseUserPeer {
	...
	/** the column name for the RFID_TAG field */
	const RFID_TAG = 'user.RFID_TAG';

	/** the column name for the RFID_NUMBER field */
	const RFID_NUMBER = 'user.RFID_NUMBER';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Picture', 'RfidTag', 'RfidNumber', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'picture', 'rfidTag', 'rfidNumber', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::PICTURE, self::RFID_TAG, self::RFID_NUMBER, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'picture', 'rfid_tag', 'rfid_number', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Picture' => 2, 'RfidTag' => 3, 'RfidNumber' => 4, 'CreatedAt' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'picture' => 2, 'rfidTag' => 3, 'rfidNumber' => 4, 'createdAt' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::PICTURE => 2, self::RFID_TAG => 3, self::RFID_NUMBER => 4, self::CREATED_AT => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'picture' => 2, 'rfid_tag' => 3, 'rfid_number' => 4, 'created_at' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UserPeer::RFID_TAG);
		$criteria->addSelectColumn(UserPeer::RFID_NUMBER);
	...
	{
		// invalidate objects in WingPeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			// delete related Wing objects
			$criteria = new Criteria(WingPeer::DATABASE_NAME);
			
			$criteria->add(WingPeer::USER_ID, $obj->getId());
			$affectedRows += WingPeer::doDelete($criteria, $con);
		}
		return $affectedRows;
	}
