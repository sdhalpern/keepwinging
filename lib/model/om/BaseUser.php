...
abstract class BaseUser extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the rfid_number field.
	 * @var        int
	 */
	protected $rfid_number;
	...
	/**
	 * Get the [rfid_number] column value.
	 * 
	 * @return     int
	 */
	...
	/**
	 * Set the value of [rfid_number] column.
	 * 
	 * @param      int $v new value
	 * @return     User The current object (for fluent API support)
	 */
	public function setRfidNumber($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->rfid_number !== $v) {
			$this->rfid_number = $v;
			$this->modifiedColumns[] = UserPeer::RFID_NUMBER;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->rfid_tag = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->rfid_number = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			$keys[0] => $this->getId(),
			$keys[1] => $this->getName(),
			$keys[2] => $this->getRfidTag(),
			$keys[3] => $this->getRfidNumber(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[2], $arr)) $this->setRfidTag($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setRfidNumber($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(UserPeer::RFID_NUMBER)) $criteria->add(UserPeer::RFID_NUMBER, $this->rfid_number);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setRfidNumber($this->rfid_number);
