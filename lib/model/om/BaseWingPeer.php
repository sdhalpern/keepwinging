...
abstract class BaseWingPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UserId', 'Number', 'CreatedAt', 'Id', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'number', 'createdAt', 'id', ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID, self::NUMBER, self::CREATED_AT, self::ID, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id', 'number', 'created_at', 'id', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'Number' => 1, 'CreatedAt' => 2, 'Id' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'number' => 1, 'createdAt' => 2, 'id' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID => 0, self::NUMBER => 1, self::CREATED_AT => 2, self::ID => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'number' => 1, 'created_at' => 2, 'id' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
