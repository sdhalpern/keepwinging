...
abstract class BaseTag extends BaseObject  implements Persistent {
	...
	public function setNumber($v)
	{
		...
		if ($this->number !== $v) {
			$this->number = $v;
			$this->modifiedColumns[] = TagPeer::NUMBER;
		}
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TagPeer::NUMBER)) $criteria->add(TagPeer::NUMBER, $this->number);
	 ...
	 * related Users from storage. If this Tag is new, it will return
		...
		if ($this->collUsers === null) {
			if ($this->isNew()) {
			   $this->collUsers = array();
				...
				$criteria->add(UserPeer::TAG_ID, $this->id);
