...
abstract class BaseScanLogPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'TagId', 'Skipped', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'tagId', 'skipped', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TAG_ID, self::SKIPPED, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'tag_id', 'skipped', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'TagId' => 1, 'Skipped' => 2, 'CreatedAt' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'tagId' => 1, 'skipped' => 2, 'createdAt' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TAG_ID => 1, self::SKIPPED => 2, self::CREATED_AT => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'tag_id' => 1, 'skipped' => 2, 'created_at' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ScanLogPeer::TAG_ID);
	...
	public static function doCountJoinTag(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(ScanLogPeer::TAG_ID, TagPeer::ID, $join_behavior);
	...
	/**
	 * Selects a collection of ScanLog objects pre-filled with their Tag objects.
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 * @return     array Array of ScanLog objects.
	 * @throws     PropelException Any exceptions caught during processing will be
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinTag(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ScanLogPeer::addSelectColumns($criteria);
		$startcol = (ScanLogPeer::NUM_COLUMNS - ScanLogPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = ScanLogPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = ScanLogPeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://propel.phpdb.org/trac/ticket/509
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				ScanLogPeer::addInstanceToPool($obj1, $key1);
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (ScanLog) to $obj2 (Tag)
				$obj2->addScanLog($obj1);
	...
	/**
	 * Selects a collection of ScanLog objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $criteria
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $criteria, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ScanLogPeer::addSelectColumns($criteria);
		$startcol2 = (ScanLogPeer::NUM_COLUMNS - ScanLogPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (ScanLog) to the collection in $obj2 (Tag)
				$obj2->addScanLog($obj1);
