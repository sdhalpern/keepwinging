...
abstract class BaseTagPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Tag', 'Number', 'CreatedAt', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'tag', 'number', 'createdAt', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::TAG, self::NUMBER, self::CREATED_AT, ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'tag', 'number', 'created_at', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Tag' => 1, 'Number' => 2, 'CreatedAt' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'tag' => 1, 'number' => 2, 'createdAt' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::TAG => 1, self::NUMBER => 2, self::CREATED_AT => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'tag' => 1, 'number' => 2, 'created_at' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(TagPeer::NUMBER);
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$criteria->add(UserPeer::TAG_ID, $obj->getId());
